import { FaTimes, FaCheck, FaMapMarker } from "react-icons/fa";
    ...
    <main>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mt-6">
        ...
        <div className="flex justify-center gap-4 text-blue-500 mb-4 text-xl space-x-9">
          <p>
            <MdAirlineSeatReclineExtra className="inline-block" />
            {vehicle.number_of_seats}
            <span className="hidden sm:inline"> Seats</span>
          </p>
        </div>
        <p className="text-gray-500 mb-4 text-center">{vehicle.description}</p>
      </div>
